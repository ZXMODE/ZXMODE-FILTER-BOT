...
API_ID = int(environ.get('API_ID', '25996402'))
API_HASH = environ.get('API_HASH', 'c6854eef98f1a182a82ead5ce5eb1bad')
BOT_TOKEN = environ.get('BOT_TOKEN', "7526000851:AAGjQ6_8hA6k42bdZquxTRtfDQ_Tf7h9I8A")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002532332647'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002408498757').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002519333491') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002525930074')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

# This Channel Is For /batch command file store.
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002273003602')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://charliezxzx96:<db_password>@cluster0.nkrm5l2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "ELO MOVIE BOT")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'ZX_MODE')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+v0H6BdpwR-5jZjA1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ZX_MODE')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Pablozinmaker') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ZX_MODE')
...
MSG_ALRT = environ.get('MSG_ALRT', 'ELO My Dear Friends ❤️')
